...
//   getting stored data from local storage;
  ...
  if (MySearchdata == null) {
    ...
    MySearchdata.map((item) => {
      line = `<div id='para'>  <div id='searchText'>${item.search}</div> 
            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <div id='dateTime'> ${item.time}</div>
             </div>`;
    });
    rows.innerHTML = line;
  }
